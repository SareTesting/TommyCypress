describe('MyTestSuite', function() 
{
    ...
    cy.get('#signin-email').type('test1@test.nl')
  ...
  cy.get('.myAccount > .nav__list-item__link > span > p').click()
    ...
    cy.get(":nth-child(2) > .errorMsg").contains("Voornaam is verplicht.")
    cy.get(":nth-child(3) > .errorMsg").contains("Achternaam is verplicht.")
    cy.get(":nth-child(7) > .errorMsg").contains("Postcode is verplicht.")
